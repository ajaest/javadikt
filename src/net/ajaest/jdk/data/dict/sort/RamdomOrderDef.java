...
//TODO: JavaDoc
public class RamdomOrderDef extends OrderDef {

	protected RamdomOrderDef(KanjiFieldEnum sortField, List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
		super(sortField, booleanConnector, domains);
