...
//TODO: JavaDoc
public class StringOrderDef extends OrderDef {

	protected StringOrderDef(KanjiFieldEnum field, List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
		super(field, booleanConnector, domains);
	}

	public KanjiSortExpression alphabetically() {
		this.setOrderBy(SortCaseEnum.Alphabetically);
		return new KanjiSortExpression(super.previousBConnector, super.queryDomains);
	}

	public KanjiSortExpression alphabetically_inverse() {
		this.setOrderBy(SortCaseEnum.AlphabeticallyInverse);
		return new KanjiSortExpression(super.previousBConnector, super.queryDomains);
	}
