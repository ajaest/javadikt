...
//TODO: JavaDoc
public abstract class IndexPairQAbout extends ValueQAbout<Pair<String, Integer>> {

	protected IndexPairQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
