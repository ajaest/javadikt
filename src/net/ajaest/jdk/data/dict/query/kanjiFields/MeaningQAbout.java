...
/**
 * QAbout class that represents a kanji meaning domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class MeaningQAbout extends StringValueQAbout {

	protected MeaningQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public KanjiFieldEnum getFieldEnum() {
		...
		return KanjiFieldEnum.KANJI_MEANING;
	}
