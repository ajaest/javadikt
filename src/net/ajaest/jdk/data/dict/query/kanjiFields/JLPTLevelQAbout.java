...
/**
 * QAbout class that represents a kanji JLPT level domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class JLPTLevelQAbout extends IntegerValueQAbout {

	protected JLPTLevelQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public KanjiFieldEnum getFieldEnum() {
		...
		return KanjiFieldEnum.KANJI_JLPT_LEVEL;
	}
