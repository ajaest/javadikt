...
//TODO: JavaDoc
public class ReadingPairQAbout extends StringPairQAbout {

	protected ReadingPairQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
		super(booleanConnector, domains);
	}

	@Override
	public KanjiFieldEnum getFieldEnum() {
		return KanjiFieldEnum.PAIR_READING;
	}
