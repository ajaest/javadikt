...
/**
 * QAbout class that represents a kanji frequency domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class FrequencyQAbout extends IntegerValueQAbout {

	protected FrequencyQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public KanjiFieldEnum getFieldEnum() {
		...
		return KanjiFieldEnum.KANJI_FREQUENCY;
	}
}
