...
/**
 * QAbout class that represents a stroke miscount domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class CommonStrokeMiscountQAbout extends IntegerValueQAbout {

	protected CommonStrokeMiscountQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public String getFieldName() {
		...
		return "Stroke miscount";
	}

	@Override
	public KanjiFieldEnum getFieldEnum() {

		return KanjiFieldEnum.KANJI_STROKE_MISCOUNT;
	}
}
