...
/**
 * QAbout class that represents a kanji dictionary name domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class DicNameQAbout extends StringValueQAbout {

	protected DicNameQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public KanjiFieldEnum getFieldEnum() {
		...
		return KanjiFieldEnum.KANJI_DIC_NAME;
	}
}
