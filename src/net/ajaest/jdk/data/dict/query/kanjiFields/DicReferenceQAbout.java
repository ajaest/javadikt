...
/**
 * QAbout class that represents a kanji dictionary reference domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class DicReferenceQAbout extends IntegerValueQAbout {

	protected DicReferenceQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public KanjiFieldEnum getFieldEnum() {
		...
		return KanjiFieldEnum.KANJI_DIC_INDEX;
	}
}
