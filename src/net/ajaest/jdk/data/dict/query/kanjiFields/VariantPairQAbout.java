...
//TODO: JavaDoc
public class VariantPairQAbout extends StringPairQAbout {

	protected VariantPairQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
		super(booleanConnector, domains);
	}

	@Override
	public KanjiFieldEnum getFieldEnum() {
		return KanjiFieldEnum.PAIR_VARIANT;
	}
