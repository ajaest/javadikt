...
/**
 * QAbout class that represents a kanji De Roo query code domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class DeRooQAbout extends StringValueQAbout {

	protected DeRooQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public KanjiFieldEnum getFieldEnum() {
		...
		return KanjiFieldEnum.KANJI_DE_ROO;
	}
}
