...
/**
 * QAbout class that represents a kanji reading domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class ReadingQAbout extends StringValueQAbout {

	protected ReadingQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public KanjiFieldEnum getFieldEnum() {
		...
		return KanjiFieldEnum.KANJI_READING;
	}
}
