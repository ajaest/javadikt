...
/**
 * QAbout class that represents a kanji grade domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class GradeQAbout extends IntegerValueQAbout {

	protected GradeQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public KanjiFieldEnum getFieldEnum() {
		...
		return KanjiFieldEnum.KANJI_GRADE;
	}
}
