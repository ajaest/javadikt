...
/**
 * QAbout class that represents a kanji JIS kuten value domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class JISCodeQAbout extends StringValueQAbout {

	protected JISCodeQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public KanjiFieldEnum getFieldEnum() {
		...
		return KanjiFieldEnum.KANJI_JIS_CODE;
	}
}
