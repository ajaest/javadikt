...
/**
 * QAbout class that represents a kanji graph representation domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class KanjiGraphQAbout extends ValueQAbout<KanjiGraph> {

	protected KanjiGraphQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public KanjiFieldEnum getFieldEnum() {
		...
		return KanjiFieldEnum.KANJI_GRAPH;
	}
}
