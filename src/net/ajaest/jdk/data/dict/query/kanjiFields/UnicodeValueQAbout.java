...
/**
 * QAbout class that represents a kanji unicode value domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class UnicodeValueQAbout extends IntegerValueQAbout {

	protected UnicodeValueQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public KanjiFieldEnum getFieldEnum() {
		...
		return KanjiFieldEnum.KANJI_UNICODE_VALUE;
	}
