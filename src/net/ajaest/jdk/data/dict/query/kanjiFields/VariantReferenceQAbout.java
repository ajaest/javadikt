...
/**
 * QAbout class that represents a kanji variant domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class VariantReferenceQAbout extends StringValueQAbout {

	protected VariantReferenceQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public KanjiFieldEnum getFieldEnum() {
		...
		return KanjiFieldEnum.KANJI_VARIANT_INDEX;
	}
