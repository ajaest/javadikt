 ...
 * 
 */
public class SpahnHadamitzkyQAbout extends StringValueQAbout {

	protected SpahnHadamitzkyQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public String getFieldName() {
		...
		return "Spahn-Hadamitzky code";
	}

	@Override
	public KanjiFieldEnum getFieldEnum() {

		return KanjiFieldEnum.KANJI_SPAHN_HADAMITZKY;
	}
