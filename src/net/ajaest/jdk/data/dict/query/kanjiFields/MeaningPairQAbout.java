...
//TODO: JavaDoc
public class MeaningPairQAbout extends StringPairQAbout {

	protected MeaningPairQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
		super(booleanConnector, domains);
	}

	@Override
	public KanjiFieldEnum getFieldEnum() {
		return KanjiFieldEnum.PAIR_MEANING;
	}
