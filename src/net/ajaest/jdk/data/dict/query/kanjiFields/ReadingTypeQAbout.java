...
/**
 * QAbout class that represents a kanji reading type domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class ReadingTypeQAbout extends StringValueQAbout {

	protected ReadingTypeQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public KanjiFieldEnum getFieldEnum() {
		...
		return KanjiFieldEnum.KANJI_READING_TYPE;
	}
