...
/**
 * QAbout class that represents a kanji four corner query code domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class FourCornerQAbout extends StringValueQAbout {

	protected FourCornerQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public String getFieldName() {
		...
		return "Four corner code";
	}

	@Override
	public KanjiFieldEnum getFieldEnum() {

		return KanjiFieldEnum.KANJI_FOUR_CORNER;
	}
