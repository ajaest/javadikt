...
/**
 * QAbout class that represents a kanji Nelson classic radical number domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class ClassicNelsonQAbout extends IntegerValueQAbout {

	protected ClassicNelsonQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public String getFieldName() {
		...
		return "Classic nelson radical";
	}

	@Override
	public KanjiFieldEnum getFieldEnum() {

		return KanjiFieldEnum.KANJI_CLASSIC_NELSON;
	}
}
