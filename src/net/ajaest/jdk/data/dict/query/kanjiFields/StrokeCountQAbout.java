 ...
 * 
 */
public class StrokeCountQAbout extends IntegerValueQAbout {

	protected StrokeCountQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public KanjiFieldEnum getFieldEnum() {
		...
		return KanjiFieldEnum.KANJI_STROKE_COUNT;
	}
}
