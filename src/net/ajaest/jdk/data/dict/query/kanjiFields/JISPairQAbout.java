...
//TODO: JavaDoc
public class JISPairQAbout extends StringPairQAbout {

	protected JISPairQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
		super(booleanConnector, domains);
	}

	@Override
	public KanjiFieldEnum getFieldEnum() {
		return KanjiFieldEnum.PAIR_JIS;
	}
