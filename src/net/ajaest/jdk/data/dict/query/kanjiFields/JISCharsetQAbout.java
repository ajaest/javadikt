...
/**
 * QAbout class that represents a kanji JIS charset domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class JISCharsetQAbout extends StringValueQAbout {

	protected JISCharsetQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public KanjiFieldEnum getFieldEnum() {
		...
		return KanjiFieldEnum.KANJI_JIS_CHARSET;
	}
