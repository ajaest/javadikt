 ...
 * 
 */
public class SkipQAbout extends StringValueQAbout {

	protected SkipQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public KanjiFieldEnum getFieldEnum() {
		...
		return KanjiFieldEnum.KANJI_SKIP;
	}
}
