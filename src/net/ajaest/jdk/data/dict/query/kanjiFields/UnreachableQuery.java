...
import net.ajaest.jdk.data.dict.query.KanjiFieldDescriptor;

//TODO: JavaDoc
public class UnreachableQuery extends QAbout implements KanjiFieldDescriptor {

	protected UnreachableQuery(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
