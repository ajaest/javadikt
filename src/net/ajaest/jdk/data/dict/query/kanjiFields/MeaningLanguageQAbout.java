...
/**
 * QAbout class that represents a kanji meaning language domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class MeaningLanguageQAbout extends StringValueQAbout {

	protected MeaningLanguageQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public String getFieldName() {
		...
		return "Meaning languaje";
	}

	@Override
	public KanjiFieldEnum getFieldEnum() {

		return KanjiFieldEnum.KANJI_MEANING_LANGUAGE;
	}
