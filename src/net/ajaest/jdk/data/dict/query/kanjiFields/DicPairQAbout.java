...
//TODO: JavaDoc
public class DicPairQAbout extends IndexPairQAbout {

	protected DicPairQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
		super(booleanConnector, domains);
	}

	@Override
	public KanjiFieldEnum getFieldEnum() {
		return KanjiFieldEnum.PAIR_DIC;
	}
