...
/**
 * QAbout class that represents a kanji classic radical number domain.
 * 
 * @author Luis Alfonso Arce González
 * 
 */
public class ClassicRadicalQAbout extends IntegerValueQAbout {

	protected ClassicRadicalQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
	...
	public String getFieldName() {
		...
		return "Classic radical";
	}

	@Override
	public KanjiFieldEnum getFieldEnum() {

		return KanjiFieldEnum.KANJI_CLASSIC_RADICAL;
	}
}
