...
//TODO: JavaDoc
public abstract class StringPairQAbout extends ValueQAbout<Pair<String,String>> {

	protected StringPairQAbout(List<ConnectorEnum> booleanConnector, List<QAbout> domains) {
