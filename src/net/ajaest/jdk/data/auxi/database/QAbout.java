...
public class QAbout {
	...
	/**
	 * It returns an unmodifiable list of objects that inherits from {@code
	 * QAbout}.
	 * 
	 * @return The sorted list of objects containing domain classes
	 */
	public List<QAbout> getDomains() {
		return Collections.unmodifiableList(queryDomains);
	}
	...
	/**
	 * Returns an unmodifiable list of boolean connector where {@code
	 * previusBConector.get(i)} contains relation between {@code
	 * queryAbout.get(i)} and {@code queryAbout.get(i-1)}
	 * 
	 * @return The sorted list of boolean connectors
	 */
	public List<ConnectorEnum> getBooleanCases() {
		return Collections.unmodifiableList(previousBConnector);
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((queryDomains == null) ? 0 : queryDomains.hashCode());
		return result;
	}
