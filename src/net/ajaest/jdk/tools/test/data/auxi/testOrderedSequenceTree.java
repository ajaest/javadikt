...
import net.ajaest.lib.data.OrderedSequenceTree;
...
//TODO: JavaDoc
public class testOrderedSequenceTree extends TestCase {
	...
	public static void main(String... args) throws Exception {
		...
		testOrderedSequenceTree t1 = new testOrderedSequenceTree();
		OrderedSequenceTree<AllowedStrokeLineEnum, Integer> test;
		t1.setUp();
		test = t1.ost;
	...
	OrderedSequenceTree<AllowedStrokeLineEnum, Integer> ost = null;

	OrderedSequenceTree<AllowedStrokeLineEnum, Integer> temp = null;

	public void printSequenceTree(OrderedSequenceTree<AllowedStrokeLineEnum, Integer> st) {
	...
	protected void setUp() throws Exception {
		...
		// void tree
		this.temp = new OrderedSequenceTree<AllowedStrokeLineEnum, Integer>(false);

		// full tree
		this.ost = new OrderedSequenceTree<AllowedStrokeLineEnum, Integer>(false);

		Map<Integer, KanjiGraph> kgmap = new StrokeOrderParser("resources/data/strokedata.txt", false).parse();
		...
		CriteriaQuery mainStrokeTree = new CriteriaQuery(OrderedSequenceTree.class, Where.isNull("parent"));
		Objects<OrderedSequenceTree<AllowedStrokeLineEnum, Integer>> graphTreeResult = odb.getObjects(mainStrokeTree);
	...
	public void testAdd() {
		...
		OrderedSequenceTree<AllowedStrokeLineEnum, Integer> test = this.temp.getSubTree(AllowedStrokeLineEnum.B);
	...
	public void testConstructor() {
		...
		this.temp = new OrderedSequenceTree<AllowedStrokeLineEnum, Integer>(true);
