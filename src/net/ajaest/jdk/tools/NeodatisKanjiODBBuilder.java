...
//TODO: JavaDoc
public class NeodatisKanjiODBBuilder {
	...
	public void construct(String kanjidict, String strokeOrder, String radical,String kanjiODB) throws FileNotFoundException, SAXException, IOException {
		...
		for (Kanji k : kanjis) {
			...
			k.setClassicRadical(radicals.get(radNum));
		}
	...
	public static void main(String... args) {
		...
		NeodatisKanjiODBBuilder kb = new NeodatisKanjiODBBuilder();
		try {
